...
class MembersSerializer(serializers.HyperlinkedModelSerializer):
    ...
    #     return recipe
class UserStoreSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        models = Store
        fields = (
        'url',
...
class StoreSerializer(serializers.HyperlinkedModelSerializer):
    ...
    store_category = serializers.SlugRelatedField(queryset=StoreCategory.objects.all(),slug_field='name')
